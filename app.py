...
model_path = '"C:/Users/hemus/OneDrive/Desktop/streamlit_app/gradient_boosting_regressor.pkl"'
...
scaler = MinMaxScaler()
scaler.min_, scaler.scale_ = np.array([min_lat, min_long]), np.array([max_lat - min_lat, max_long - min_long])
