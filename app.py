...
def add_bg_from_url():
    st.markdown(
        ...
        <style>
        .stApp {
            background-image: url("https://thumbs.dreamstime.com/b/blurred-new-york-city-skyline-abstract-urban-background-color-toned-picture-usa-blurred-new-york-city-skyline-usa-134383438.jpg");
