...
def user_input_features():
    ...
    data.update({
        'neighbourhood_group_Manhattan': 1 if neighbourhood_group_default == 'Manhattan' else 0,
        'neighbourhood_group_Brooklyn': 1 if neighbourhood_group_default == 'Brooklyn' else 0,
        'neighbourhood_group_Queens': 1 if neighbourhood_group_default == 'Queens' else 0,
        'neighbourhood_group_Staten_Island': 1 if neighbourhood_group_default == 'Staten Island' else 0,
        'neighbourhood_group_Bronx': 1 if neighbourhood_group_default == 'Bronx' else 0,
        'room_type_Entire_home_apt': 1 if room_type_default == 'Entire home/apt' else 0,
        'room_type_Private_room': 1 if room_type_default == 'Private room' else 0,
        'room_type_Shared_room': 1 if room_type_default == 'Shared room' else 0
    })
